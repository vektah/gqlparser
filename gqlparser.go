...
func LoadQuery(schema *ast.Schema, str string, coercion coerce.ScalarFunc) (*ast.QueryDocument, gqlerror.List) {
...
func MustLoadQuery(schema *ast.Schema, str string, coercion coerce.ScalarFunc) *ast.QueryDocument {
